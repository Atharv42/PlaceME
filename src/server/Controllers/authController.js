...
const StudentSignUp = async (req, res) => {
    console.log("Attempting student registration for:", req.body.email);
    try {
        const {
        ...
        console.log("Hashing password for student..."); 
...
const CompanySignUp = async (req, res) => {
    console.log("Attempting company registration for:", req.body.companyEmail);
    try {
        ...
        console.log("Hashing password for company..."); 
...
const AdminSignUp = async (req, res) => {
    console.log("Attempting admin registration for:", req.body.adminEmail); 
    try {
    ...
    try {
        ...
        if (!user) {
            ...
            if (user) {
                ...
                console.log("Found user in Student collection.");
            }
        }

       
        if (!user) {
            console.log("Checking Company collection..."); 
        ...
        switch(userType) {
            ...
            default:
                console.error("Invalid userType determined during login:", userType); 
        ...
        if (userType === 'company' && !user.isVerified) {
            console.log("Company login denied - not verified:", email); 
        ...
        console.log("Token signed successfully for:", userType); 
...
const resetPassword = async (req, res) => {
    ...
    try {
        ...
        console.log("Token found and valid for user:", passwordResetToken.userId, passwordResetToken.userModel); 
        ...
        switch (passwordResetToken.userModel) {
            ...
            default:
                console.error("Invalid userModel found in token:", passwordResetToken.userModel); 
        ...
        if (!user) {
            console.log("User for reset token not found:", passwordResetToken.userId); 
        ...
        console.log("Saving updated user password..."); 
        await user.save();
